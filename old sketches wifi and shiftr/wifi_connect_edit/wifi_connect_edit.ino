...
char ssid[] = "Verdieping 3 Koelkast";        // your network SSID (name)
char pass[] = "Kutinternet123";    // your network password (use for WPA, or use as key for WEP)
